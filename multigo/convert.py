...
class Converter(nn.Module):
    ...
    def render_gs(self, pose, size):
        ...
        out = self.gs_renderer.render(self.gaussians.unsqueeze(0), cam_view.unsqueeze(0), cam_view_proj.unsqueeze(0), cam_pos.unsqueeze(0), output_size=size)
    ...
    def fit_nerf(self, iters=512, resolution=256):
        ...
        for i in pbar:
            ...
            image_gt, alpha_gt = self.render_gs(pose, size=resolution)
    ...
    def fit_mesh(self, iters=2048, resolution=512, decimate_target=5e4):
        ...
        for i in pbar:
            ...
            image_gt, alpha_gt = self.render_gs(pose, size=512)
