...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input-path", default='./real_img_rmbg_cropped_persons', type=str, help="Input RGBA path")
    parser.add_argument("-o", "--output-path", default='./real_img_rmbg_cropped_persons_centralized', type=str, help="Output path")
