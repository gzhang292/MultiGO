...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input-path", default='../iid_img_rmbg_cropped_persons_centralized', type=str, help="Input RGBA path")
    parser.add_argument("-o", "--output-path", default='../iid_img_rmbg_cropped_persons_centralized_estsmplx', type=str, help="Output path")
